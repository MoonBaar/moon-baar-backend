...
@WebMvcTest(EventLikeController.class)
@Import(SecurityTestConfig.class)
@AutoConfigureMockMvc(addFilters = false)
@WithMockCustomUser
public class EventLikeControllerTest {
    ...
    void likeEvent_Success() throws Exception {
        ...
        when(likeService.likeEvent(any(User.class), eq(EVENT_ID))).thenReturn(response);
    ...
    void likeEvent_AlreadyLiked() throws Exception {
        // given
        when(likeService.likeEvent(any(User.class), eq(EVENT_ID))).thenThrow(new AlreadyLikedEventException());
    ...
    void unlikeEvent_Success() throws Exception {
        ...
        when(likeService.unlikeEvent(any(User.class), eq(EVENT_ID))).thenReturn(response);
    ...
    void unlikeEvent_NotLiked() throws Exception {
        // given
        when(likeService.unlikeEvent(any(User.class), eq(EVENT_ID))).thenThrow(new LikeNotFoundException());
